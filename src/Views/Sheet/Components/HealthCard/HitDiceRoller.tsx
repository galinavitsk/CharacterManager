...
const mapStateToProps = state => {
  ...
  const HitDiceRoller = props=>{
      ...
      const RollHitDice=()=>{
          ...
          setSubstring("("+hitDiceRolled+")+"+GetAbilityMod(props.constitution));
    ...
    const Accept=()=>{
        ...
        props.onHClose();
            ...
            return(<>
      <div className="row" style={{fontSize:"20px",color:"#708F93",justifyContent:"center"}}>
        Spend d{props.HD} HD
    </div>
    <div className="row" style={{fontSize:"16px",color:"#708F93",justifyContent:"center"}}>
        {props.CHD}d{props.HD}
    </div>
<div className="row">
    <div className="col-3 icon" style={{fontSize:"40px",textAlign:"center"}} onClick={()=>{RollHitDice()}}>
<FontAwesomeIcon icon={faDiceD20}/>
    </div>
    <div className="col-6" style={{fontSize:"40px",color:"#708F93",textAlign:"center"}}>
        {rolled}
    </div>
    <div className="col-3 icon" style={{fontSize:"40px",textAlign:"center"}} onClick={()=>{Accept()}}>
    <FontAwesomeIcon icon={faCheck}/>
    </div>
</div>

<div className="row" style={{fontSize:"12px",color:"#708F93",justifyContent:"center"}}>
        {substring}
    </div>
</>
      );
